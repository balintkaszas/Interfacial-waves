...
OPEN(50,file ='tanh/rho.dat',form='formatted')
OPEN(60, file = 'tanh/10/rho_timeseries_13.dat', form ='formatted')
OPEN(70, file = 'tanh/10/rho_timeseries_14.dat', form ='formatted')
